...
```bash
python3 tools/scan_books.py --lang it    # Italian books only
python3 tools/scan_books.py --lang en    # English books only
python3 tools/scan_books.py               # All languages (default)
```
...
python3 tools/setup_database.py download

# Import into SQLite (all languages)
python3 tools/setup_database.py import

# Import only Italian books
python3 tools/setup_database.py import --lang it

# Build full-text search index (recommended, ~20-40 min)
python3 tools/setup_database.py create-fts

# Check statistics
python3 tools/setup_database.py stats
```
...
```
python3 tools/scan_books.py [OPTIONS]
...
software/
  ...
  config/               # Runtime data (not in git)
    ...
    books.db            # SQLite database (generated by setup_database.py, not in git)
  tools/
